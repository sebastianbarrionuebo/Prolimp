...
@Component({
  selector: 'app-mantenimiento-sanitario-page',
  templateUrl: './mantenimiento-sanitario-page.component.html',
  styleUrls: ['./mantenimiento-sanitario-page.component.css']
})
export class MantenimientoSanitarioPageComponent implements OnInit {
  ...
  irAFilmacionCanierias() {
    this.router.navigate(['Servicios/Mantenimiento-Sanitario/Filmacion-de-cañerias']);
  }
